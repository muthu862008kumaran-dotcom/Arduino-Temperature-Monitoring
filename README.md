...
Arduino-based temperature monitoring system using an LM35 sensor and 16x2 I2C LCD. It displays real-time temperature readings and sends data to the Serial Monitor.
